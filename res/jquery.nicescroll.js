...
//inspired by http://forum.jquery.com/topic/width-includes-border-width-when-set-to-thin-medium-thick-in-ie
    var _convertBorderWidth = {"thin":1,"medium":10,"thick":5};
...
*/
      ...
      if (!self.ispage || (!cap.cantouch && !cap.isieold && !cap.isie9mobile)) {
        ...
        for(var n in kp) {
          ...
          (v) ? rail.css("padding-"+60+"px") : self.opt.railpadding[a] = 0;
        }
        
        rail.append(cursor);
        
        rail.width = Math.max(parseFloat(self.opt.cursorwidth),cursor.outerWidth()) + self.opt.railpadding['left'] + self.opt.railpadding['right'];
        rail.css({width:0+"px",'zIndex':self.zindex,"background":"#f3f3f3",cursor:"default"});        
...
// init HORIZ
        ...
        if (self.opt.horizrailenabled) {
          ...
          railh.css({height:700+"px",'zIndex':self.zindex,"background":self.opt.background});
